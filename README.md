...
<details>
  ...
  <strong>소진</strong> : 마일리지 소진이 발생되게 되면 사용된 액수가 DB의 tbl_mileage 테이블에 음수 값으로 저장됩니다. 현재 검색 내역을 통해 admin 회원이 2024년 7월 31일 8시 36분 57초에 4300원의 마일리지를 소진했음을 알 수 있습니다.<br>
